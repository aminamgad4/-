# مُصدِّر الفواتير المحسن - ETA Invoice Exporter Enhanced Pro

إضافة Chrome مجانية ومحسنة لاستخراج وتصدير بيانات الفواتير من بوابة الفاتورة الإلكترونية المصرية مع أزرار العرض التفاعلية.

## 🚀 المميزات

### المميزات الجديدة في الإصدار 2.1.0
- **أزرار العرض التفاصيلية**: عرض تفاصيل الفاتورة كاملة عند النقر على زر "عرض" في Excel
- **ترتيب الأعمدة RTL**: العمود A يبدأ من اليمين للقراءة العربية الصحيحة
- **تفاصيل الأصناف**: عرض تفصيلي لأصناف كل فاتورة
- **تعليقات تفصيلية**: معلومات شاملة عن كل فاتورة في تعليقات Excel
- **دعم RTL كامل**: اتجاه القراءة من اليمين لليسار في Excel
...
- ✅ أزرار العرض التفاعلية (مكتمل)
- ✅ ترتيب الأعمدة المحسن (مكتمل)
- خيارات تصفية متقدمة (قريباً)
- حفظ الإعدادات المفضلة (قريباً)

---

**ملاحظة**: هذه الإضافة غير مرتبطة رسمياً بمصلحة الضرائب المصرية. إنها أداة مساعدة محسنة مطورة لتسهيل العمل مع بوابة الفاتورة الإلكترونية.